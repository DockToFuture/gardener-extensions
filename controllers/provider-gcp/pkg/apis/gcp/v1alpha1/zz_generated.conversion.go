...
func RegisterConversions(s *runtime.Scheme) error {
	...
	if err := s.AddGeneratedConversionFunc((*FlowLogConfig)(nil), (*gcp.FlowLogConfig)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_v1alpha1_FlowLogConfig_To_gcp_FlowLogConfig(a.(*FlowLogConfig), b.(*gcp.FlowLogConfig), scope)
	}); err != nil {
		return err
	}
	if err := s.AddGeneratedConversionFunc((*gcp.FlowLogConfig)(nil), (*FlowLogConfig)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_gcp_FlowLogConfig_To_v1alpha1_FlowLogConfig(a.(*gcp.FlowLogConfig), b.(*FlowLogConfig), scope)
	}); err != nil {
		return err
	}
...
func autoConvert_v1alpha1_FlowLogConfig_To_gcp_FlowLogConfig(in *FlowLogConfig, out *gcp.FlowLogConfig, s conversion.Scope) error {
...
// Convert_v1alpha1_FlowLogConfig_To_gcp_FlowLogConfig is an autogenerated conversion function.
func Convert_v1alpha1_FlowLogConfig_To_gcp_FlowLogConfig(in *FlowLogConfig, out *gcp.FlowLogConfig, s conversion.Scope) error {
	return autoConvert_v1alpha1_FlowLogConfig_To_gcp_FlowLogConfig(in, out, s)
}

func autoConvert_gcp_FlowLogConfig_To_v1alpha1_FlowLogConfig(in *gcp.FlowLogConfig, out *FlowLogConfig, s conversion.Scope) error {
	out.AggregationInterval = in.AggregationInterval
	out.FlowSampling = in.FlowSampling
	out.Metadata = in.Metadata
	return nil
...
// Convert_gcp_FlowLogConfig_To_v1alpha1_FlowLogConfig is an autogenerated conversion function.
func Convert_gcp_FlowLogConfig_To_v1alpha1_FlowLogConfig(in *gcp.FlowLogConfig, out *FlowLogConfig, s conversion.Scope) error {
	return autoConvert_gcp_FlowLogConfig_To_v1alpha1_FlowLogConfig(in, out, s)
}
...
func autoConvert_v1alpha1_NetworkConfig_To_gcp_NetworkConfig(in *NetworkConfig, out *gcp.NetworkConfig, s conversion.Scope) error {
	...
	out.EnableFlowLogs = in.EnableFlowLogs
	if err := Convert_v1alpha1_FlowLogConfig_To_gcp_FlowLogConfig(&in.FlowLogConfig, &out.FlowLogConfig, s); err != nil {
		return err
	}
	return nil
}
...
func autoConvert_gcp_NetworkConfig_To_v1alpha1_NetworkConfig(in *gcp.NetworkConfig, out *NetworkConfig, s conversion.Scope) error {
	...
	out.Worker = in.Worker
	out.EnableFlowLogs = in.EnableFlowLogs
	if err := Convert_gcp_FlowLogConfig_To_v1alpha1_FlowLogConfig(&in.FlowLogConfig, &out.FlowLogConfig, s); err != nil {
		return err
	}
	return nil
}
